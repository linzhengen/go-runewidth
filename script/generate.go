...
func main() {
	...
	resp, err := http.Get("https://www.unicode.org/Public/UCD/latest/ucd/EastAsianWidth.txt")
	if err != nil {
		log.Fatal(err)
	}
	...
	resp, err = http.Get("https://www.unicode.org/Public/UCD/latest/ucd/emoji/emoji-data.txt")
	if err != nil {
		log.Fatal(err)
	}
	defer resp.Body.Close()
